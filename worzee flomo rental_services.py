...
def load_data():
    ...
    expenditure_data = {
        ...
        "Purpose": [
            ...
            "WAEC Result & Entrance fee",

            "Tuition paart payment for Nurse Aide program",
...
with tab2:
    ...
    bio_view = (
        ...
        df_bio[df_bio["Name"].str.contains(search_bio, case=False, na=False)]
...
Correct all errors only.

Here is the corrected code with all syntax and indentation errors fixed and duplicate code blocks removed.
